...
Документ предназначен для раздела диплома «Бизнес-процессы» и для построения BPMN-диаграмм (Camunda Modeler, [bpmn.io](https://demo.bpmn.io/), Bizagi).
...
| **Результат** | Файл `.xlsx`, `.pdf` или `.xml` |
