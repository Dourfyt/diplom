  ...
  function commonNavSteps() {
    return [
      ...
      step('[data-tour="eco-nav-tabs"]', "Вкладки раздела", document.body.getAttribute("data-manager-only") === "1"
        ? "KPI — сводка за период; Просмотр — партии, операции и измерения (только чтение)."
      ...
      return commonNavSteps().concat(
        [
          ...
          step(
            ...
            managerOnly
              ? "Скачайте сводку KPI в Excel или PDF с учётом выбранного периода и организации."
              : "Excel, PDF и XML — операции с датами и организацией из фильтра; полный список — в «Операции».",
            "bottom"
          ),
          step(
            ...
            "Детализация",
            managerOnly
              ? "Краткий просмотр партий, операций и измерений за период."
